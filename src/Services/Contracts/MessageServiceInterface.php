 ...
 * {@see UserMessageAddedToConversation} event,
 * which is picked up by a queued listener
 * ({@see GenerateAiAssistantReply})
...
interface MessageServiceInterface
{
     ...
     * via the {@see GenerateAiAssistantReply}
     * queued listener.
     */
     ...
     * Dispatches {@see AiAssistantMessageAddedToConversation}.
     */
