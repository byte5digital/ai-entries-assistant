...
<template>
  <div class="relative w-full">
        <textarea
            ...
            :rows="minRows"
            :value="modelValue"
            class="w-full resize-none overflow-y-auto rounded-md border border-gray-300 px-3 py-2 pb-6 text-sm leading-normal focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50"
            @input="onInput"
